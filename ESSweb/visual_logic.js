...
function start_game() {
  ...
  var VARS = Object.defineProperties({}, {
    "index": { get: function() { return index; }, set: function(val) { index = val; } },
    "add_time": { get: function() { return add_time; }, set: function(val) { add_time = val; } },
    "add_score": { get: function() { return add_score; }, set: function(val) { add_score = val; } },
    "scores": { get: function() { return scores; }, set: function(val) { scores = val; } },
    "j": { get: function() { return j; }, set: function(val) { j = val; } },
    "e": { get: function() { return e; }, set: function(val) { e = val; } },
    "emptys_with_fruits": { get: function() { return emptys_with_fruits; }, set: function(val) { emptys_with_fruits = val; } },
    "random_numder": { get: function() { return random_numder; }, set: function(val) { random_numder = val; } },
    "time": { get: function() { return time; }, set: function(val) { time = val; } },
    "ground_speed": { get: function() { return ground_speed; }, set: function(val) { ground_speed = val; } },
    "fruits_max": { get: function() { return fruits_max; }, set: function(val) { fruits_max = val; } },
    "empty_to_check": { get: function() { return empty_to_check; }, set: function(val) { empty_to_check = val; } },
    "game_started": { get: function() { return game_started; }, set: function(val) { game_started = val; } },
    "emptys_distance": { get: function() { return emptys_distance; }, set: function(val) { emptys_distance = val; } },
    "farmer_position_prev": { get: function() { return farmer_position_prev; }, set: function(val) { farmer_position_prev = val; } },
    "farmer_posotion_next": { get: function() { return farmer_posotion_next; }, set: function(val) { farmer_posotion_next = val; } },
    "gamepad_timestamp": { get: function() { return gamepad_timestamp; }, set: function(val) { gamepad_timestamp = val; } },
    "fruit_count": { get: function() { return fruit_count; }, set: function(val) { fruit_count = val; } },
    "help_mode": { get: function() { return help_mode; }, set: function(val) { help_mode = val; } },
    "fruits_amount": { get: function() { return fruits_amount; }, set: function(val) { fruits_amount = val; } },
    "i": { get: function() { return i; }, set: function(val) { i = val; } },
    "empty_index": { get: function() { return empty_index; }, set: function(val) { empty_index = val; } },
    "farmers_position": { get: function() { return farmers_position; }, set: function(val) { farmers_position = val; } },
    "move_steps": { get: function() { return move_steps; }, set: function(val) { move_steps = val; } },
    "ground_speed_temp": { get: function() { return ground_speed_temp; }, set: function(val) { ground_speed_temp = val; } },
    "fruit_clone": { get: function() { return fruit_clone; }, set: function(val) { fruit_clone = val; } },
    "random_empty": { get: function() { return random_empty; }, set: function(val) { random_empty = val; } },
...
eventHTMLElem('deviceready', ['DOCUMENT'], true, function(event) {
  removeHTMLElement('fullscreen-button', true);
});
...
initFullscreen('fullscreen-button', true, function() {
  setHTMLElemStyle('backgroundImage', 'images/fullscreen_off.png', 'fullscreen-button', true);
}, function() {
  setHTMLElemStyle('backgroundImage', 'images/fullscreen_on.png', 'fullscreen-button', true);
}, function() {});
